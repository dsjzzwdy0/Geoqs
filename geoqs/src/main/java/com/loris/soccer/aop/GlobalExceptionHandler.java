...
public class GlobalExceptionHandler
{
	...
	@ResponseStatus(HttpStatus.UNAUTHORIZED)
	public String invalidUser(InvalidUserException e, Model model)
	{
		String username = getRequest().getParameter("username");
		LogManager.me().executeLog(LogTaskFactory.loginLog(username, "账号尚未被审核通过", getIp()));
		model.addAttribute("tips", "当前账号尚未被审核通过");
		return "/login";
	}
	/**
	 * 账号密码错误
