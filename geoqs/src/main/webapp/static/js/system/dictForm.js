 ...
 * 删除item
 */
DictInfoDlg.deleteItem = function (obj) {
...
DictInfoDlg.addSubmit = function () {
    ...
    var postData={
        ...
        dictTips:this.dictTips,
        dictValues:this.mutiString
    }
    var url=Geomonitor.ctxPath+"/dict/add";
    if(this.dictId){
    	url=Geomonitor.ctxPath+"/dict/update";//有id则为修改
    	postData.dictId=this.dictId;
    }
