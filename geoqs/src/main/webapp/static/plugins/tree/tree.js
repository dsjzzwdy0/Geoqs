...
(function ($) {
    ...
    $.fn.treeview = function (settings) {
        var dfop =
            {
                 ...
                 */
                cbiconpath: Geomonitor.ctxPath+"/static/plugins/tree/images/icons/",
        ...
        function setnodestate(items, id, state) {
            for (var i = 0; i < items.length; i++) {
                if (items[i].id == id) {
                    items[i].checkstate = state;
                    return;
                }
                if (items[i].ChildNodes != null) {
                    setnodestate(items[i].ChildNodes, id, state);
                }
            }
        }
        ...
        me[0].t = {
            ...
            setNodeState: function (id,state) {
                setnodestate(treenodes, id, state);
            }
        };
        return me;
    };
    ...
    $.fn.getCheckedNodesText = function () {
        if (this[0].t) {
            return this[0].t.getSelectedText();
        }
        return null;
    };
