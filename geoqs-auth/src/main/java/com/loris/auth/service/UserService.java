...
public interface UserService extends IService<User> {
     ...
     * 根据条件查询用户列表(分页)
     */
    IPage<Map<String, Object>> selectUsersByPage(@Param("page") IPage<User> page,@Param("dataScope") DataScope dataScope, @Param("name") String name, @Param("beginTime") String beginTime, @Param("endTime") String endTime, @Param("deptid") Integer deptid);
    /**
     * 设置用户的角色
     */
